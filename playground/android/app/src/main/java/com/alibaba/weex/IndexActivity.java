...
import org.weex.plugin.ShreejiPluginTest.ShreejiPluginTestModule;
import org.weex.plugin.ShreejiPluginTest.UtilityJava;
...
public class IndexActivity extends AbstractWeexActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    UtilityJava.setContext(context);
    Log.d("","shrreeji maharaj");
    ShreejiPluginTestModule shreejiPluginTestModule = new ShreejiPluginTestModule();
    shreejiPluginTestModule.testMethodNew();
  }
